...
/*   Updated: 2023/12/19 14:56:50 by brmoretti        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/**
 * @file ft_itoa_base_ulong.c
 * @brief Implementation of the ft_itoa_base_ulong function.
 */
...
/**
 * @brief Converts an unsigned long to a string representation
 * in a specified base.
 *
 * This function converts the given unsigned long to its string representation
 * in the specified base. The base must be between 2 and 36 (inclusive).
 *
 * @param n    The unsigned long to be converted.
 * @param base The base for the conversion (between 2 and 36).
 * @return     A dynamically allocated string representing the unsigned
 * long in the specified base.
